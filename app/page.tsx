  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="relative overflow-hidden py-24 md:py-32 px-6 border-b border-border bg-radial-gradient">
        ...
        >
          <motion.div 
            className="inline-flex items-center gap-2 bg-accent/10 dark:bg-accent border border-accent/20 dark:border-accent text-accent-hover dark:text-black px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider dark:shadow-[0_0_15px_rgba(232,255,77,0.5)]"
