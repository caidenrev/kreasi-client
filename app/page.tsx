  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="relative overflow-hidden py-24 md:py-32 px-6 border-b border-border bg-radial-gradient">
        ...
        >
          <motion.div 
            className="inline-flex items-center gap-2 bg-accent text-black px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-[0_0_15px_rgba(232,255,77,0.3)] dark:shadow-[0_0_15px_rgba(232,255,77,0.5)]"
